...
<div class="tab">
  <el-breadcrumb :separator-icon="ArrowRightBold">
    ...
    <el-table :data="tableData" style=border :header-cell-style="{'text-align':'center'}"  :cell-style="{'text-align':'center'}">
    ...
    <el-table-column  label="操作" width="240">
      <template #default="scope">
        ...
        <el-button type="primary" size="small" @click="handleClickDelete(scope.$index, scope.row)">删除</el-button>
      </template>
    </el-table-column>
  </el-table>
