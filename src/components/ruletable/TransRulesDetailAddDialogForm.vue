...
<el-dialog v-model="dialogFormVisible" title="新增转换条件" @close='handleCancle' >
    ...
    <el-form-item label="序号" :label-width="formLabelWidth" prop="id" >
      ...
      <el-form-item label="源字段" :label-width="formLabelWidth" prop="source" >
          ...
          <el-cascader v-model="form.sourceData" :options="sourceoptions" :props="props1" clearable style="width: 300px; " collapse-tags  @change="changeSourceInput"/>
      </el-form-item>

        <el-form-item label="目的字段" :label-width="formLabelWidth" prop="target" required>
              <el-cascader v-model="form.targetData" :options="targetoptions" :props="props1" clearable style="width: 300px;" collapse-tags @change="changeTargetInput"/>
    ...
    <div v-if="customrulediv" ref="div3">
        ...
        <div v-if="funcrulediv" ref="div4">
          ...
          <el-cascader v-model="form.funcrule" :options="funcoptions" :props="props212" clearable style="width: 300px; " collapse-tags  />
      </el-form-item>
