    ...
    <el-dialog v-model="dialogFormVisible" title="新增转换规则" @close='handleCancle'>
        ...
        <el-form :model="form" ref="formRef">
            ...
            <el-form-item label="源数据" :label-width="formLabelWidth" prop="source" required>
                ...
                <el-cascader v-model="form.sourceid" :options="options" :props="props1" clearable style="width: 300px; "
                             collapse-tags @change="changeSourceInput"/>
            </el-form-item>
            <el-form-item label="目的数据" :label-width="formLabelWidth" prop="target" required>
                <el-cascader v-model="form.targetid" :options="options" :props="props1" clearable style="width: 300px;"
                             collapse-tags @change="changeTargetInput"/>
