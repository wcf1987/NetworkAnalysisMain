 ...
 <el-divider class="boderline"/>
  ...
  <div class="pagination-block">
    ...
    />
        ...
        <InterfaceDetailAddDialogForm ref="testDialog" @addValue='addData'  @changeValue="editData"></InterfaceDetailAddDialogForm>
    </div>
    </div>
</template>
     ...
     HTTPRequest.post('/packageDetail/update',
        {
          'id':fo.id,
            ...
            //tableData.value.splice(index, 1);
            tableData.value.splice(index, 1, {'id':fo.id,'name':fo.name,'ename':fo.ename,'length':fo.length,'valuestr':fo.valuestr});
