<template>
    <el-dialog v-model="dialogFormVisible" title="新增封装头" @close='handleCancle'>
        <el-form :model="form" ref="formRef">
            ...
            <el-form-item label="封装头名称" :label-width="formLabelWidth" prop="name">
                <el-input v-model="form.name" autocomplete="off"/>
            </el-form-item>
            <el-form-item label="封装头类型" :label-width="formLabelWidth" prop="type">
