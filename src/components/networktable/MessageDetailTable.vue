 ...
 <el-divider class="boderline"/>
            ...
            <el-table-column prop="messageID" label="messageID" width="120" v-if="false"/>
                <el-table-column  label="操作" width="300">
                  <template #default="scope">
                    ...
                    <el-button type="primary" size="small" @click="handleClickEditGroup(scope.$index, scope.row)" v-if="scope.row.type=='嵌套消息体'" :icon="Message">编辑子消息体</el-button>
  ...
  <div class="pagination-block">
    ...
    />
        ...
        <MessageDetailAddDialogForm ref="testDialog" @addValue='addData'  @changeValue="editData"></MessageDetailAddDialogForm>
    </div>
    </div>
</template>
...
import {DocumentAdd,Edit,Delete,Memo, DocumentCopy,EditPen,Message}from '@element-plus/icons-vue'
    ...
    let index = tableData.value.findIndex(
         ...
         HTTPRequest.post('/messageDetail/update',
        {
          'id':fo.id,
            ...
            //tableData.value.splice(index, 1);
        tableData.value.splice(index, 1, {'id':fo.id,'name':fo.name,'ename':fo.ename,'optional':fo.optional,'length':fo.length,'type':fo.type,'valuestr':fo.valuestr});
