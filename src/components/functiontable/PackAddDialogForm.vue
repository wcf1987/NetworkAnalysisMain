<template>
    <el-dialog v-model="dialogFormVisible" title="新增封装转换函数" @close='handleCancle'>
        <el-form :model="form" ref="formRef">
            ...
            <el-form-item label="函数调用接口" :label-width="formLabelWidth" prop="type">
                <el-input v-model="form.calladdr" autocomplete="off"/>
            </el-form-item>
...
<script setup>
    ...
    const showD = (flags, row) => {
        ...
        if (flags == 1) {
            ...
            form.value.calladdr = row.calladdr
