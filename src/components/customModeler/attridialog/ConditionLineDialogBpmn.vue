<template>
    ...
    <el-form :model="form" ref="formRef">
      ...
      <el-form-item label="前序节点数据" :label-width="formLabelWidth" prop="id">
          ...
          <el-cascader v-model="form.source" :options="sourceOptions" :props="props2" clearable style="width: 300px; " collapse-tags  @change="changeSourceInput"/>
...
const  geteOptions=async (id,state,alist)=>{
    var usedlist=[]
    var waitlist=[]
    //waitlist.push(id)
    var t,k,m,n,c
    ...
    arr1=alist.value[0]
             ...
             await   HTTPRequest.post('/interfaceDetail/list',
        {
                 ...
                 if(res.data!=undefined){
                     let tempArray={
                             id: arr2.interfaceID,
                             name: arr2.interfaceName,
                             children:res.data
                     }
                sourceOptions.value.push(tempArray)
                    }
               })
