...
.node-start{
  background: url('../background/7.svg') no-repeat;
  background-size: cover;
}
.node-end{
  background: url('../background/8.svg') no-repeat;
  background-size: cover;
}
.node-app{
...
.node-message{
  background: url('../background/2.svg') no-repeat;
  background-size: cover;
}
.node-package{
  background: url('../background/3.svg') no-repeat;
  background-size: cover;
}
.node-swich{
  background: url('../background/4.svg') no-repeat;
  background-size: cover;
}
.node-connect{
  background: url('../background/5.svg') no-repeat;
  background-size: cover;
}
.node-rect{
